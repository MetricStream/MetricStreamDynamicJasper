...
public class XYLineChartBuilderTest extends BaseDjReportTest {
    ...
    protected void setUp() throws Exception {
		...
		final DJAxisFormat categoryAxisFormat = new DJAxisFormat("x");
		...
		final DJChart djChart = new DJXYLineChartBuilder()
		//chart
		.setX(20)
		.setY(10)
		.setWidth(500)
	...
	public void testPlot() {
		final JRDesignLinePlot plot = (JRDesignLinePlot) chart.getPlot();
	...
	public static void main(String[] args) throws Exception {
		final XYLineChartBuilderTest test = new XYLineChartBuilderTest();
		test.setUp();
		test.testReport();
