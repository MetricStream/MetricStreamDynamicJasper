...
public class HtmlExportReportTest extends FastReportTest {
    ...
    public void testReport() throws Exception {
         ...
         */
        final JRDataSource ds = getDataSource();
        ...
        DJServletHelper.exportToHtml(request, response,"/images", jp, null, null);
        ...
        final InputStream is = DJServletHelper.exportToHtml(request2, "/images", jp, null, null);
    ...
    public void testReport2() throws Exception {
        ...
        final MockHttpServletRequest request = new MockHttpServletRequest();
        final MockHttpServletResponse response = new MockHttpServletResponse();
        DJServletHelper.exportToHtml(request, response,"/images", dr, getLayoutManager(),getDataSource(),new HashMap(),null, null);

        //Exporting and returning an InputStream
        final MockHttpServletRequest request2 = new MockHttpServletRequest();
        final InputStream is = DJServletHelper.exportToHtml(request2,"/images", dr, getLayoutManager(),getDataSource(),new HashMap(),null, null);
        final ByteArrayOutputStream out = new ByteArrayOutputStream();
        ReportWriter.copyStreams(is,out);
	...
	public static void main(String[] args) throws Exception {
		final HtmlExportReportTest test = new HtmlExportReportTest();
		test.testReport();
		test.testReport2();
	}
