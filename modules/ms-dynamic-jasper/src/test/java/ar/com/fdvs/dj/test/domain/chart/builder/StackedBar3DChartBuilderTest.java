...
/*		GroupBuilder gb2 = new GroupBuilder();
		...
		final DJChart djChart = new DJStackedBar3DChartBuilder()
		//chart
		.setX(20)
		.setY(10)
		.setWidth(500)
	...
	public void testPlot() {
		final JRDesignBar3DPlot plot = (JRDesignBar3DPlot) chart.getPlot();
		assertEquals(10d, plot.getXOffset());
		assertEquals(10d, plot.getYOffset());
	...
	public static void main(String[] args) throws Exception {
		final StackedBar3DChartBuilderTest test = new StackedBar3DChartBuilderTest();
		test.setUp();
		test.testReport();
