...
//			.addFirstPageFooterImageBanner(getImagePath("logo_fdv_solutions_60.png"), new Integer(197), new Integer(60), ImageBanner.Alignment.Right)
//			.addFirstPageFooterImageBanner(getImagePath("dynamicJasper_60.jpg"), new Integer(300), new Integer(60), ImageBanner.Alignment.Right)
			.addFooterImageBanner(getImagePath("logo_fdv_solutions_60.png"), 100, 25, ImageBanner.Alignment.Left, ImageScaleMode.FILL)
			.addFooterImageBanner(getImagePath("dynamicJasper_60.jpg"), 150, 45, ImageBanner.Alignment.Right, ImageScaleMode.FILL)
            ;
