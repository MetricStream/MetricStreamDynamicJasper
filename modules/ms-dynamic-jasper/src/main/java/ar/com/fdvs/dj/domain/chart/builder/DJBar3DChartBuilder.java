...
public class DJBar3DChartBuilder extends AbstractChartBuilder<DJBar3DChartBuilder> {
	 ...
	 **/
	@Override
    public DJBar3DChartBuilder setLegendPosition(int legendPosition) {
	 ...
	 **/
	@Override
    public DJBar3DChartBuilder setTitlePosition(int titlePosition) {
	 ...
	 */
	@Override
    public DJBar3DChartBuilder setLineStyle(int lineStyle) {
